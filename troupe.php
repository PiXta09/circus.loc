...
<body>
	...
	<div class="container">
		<div class="row center">
			<div class="col-4">
				<h1>Фёдор Молодцов</h1>
				<img src="images/F.Molodzoff.jpg" class="rounded" width="100%">
			</div>
			<div class="col-4">
				<h1>Карандаш</h1>
				<img src="images/pensil.jpg" class="rounded" width="100%">
			</div>
			<div class="col-4">
				<h1>Братья Запашные</h1>
				<img src="images/zapashnie.jpg" class="rounded" width="100%">
			</div>
		</div>
	</div>
